...
namespace Modules.SoundSystems
{
    ...
    public class SoundSystem : MonoBehaviour
    {
        ...
        protected void Awake()
        {
            ...
            IgnoreDuplicateAmbienceSounds = false;
        ...
        public Audio GetAudio(int audioID)
        {
            ...
            audio = GetVoiceAudio(audioID);
            if (audio != null)
            {
                return audio;
            }

            audio = GetAmbienceAudio(audioID);
            if (audio != null)
            {
                return audio;
            }
        ...
        {
            // Stop all current music playing first so the newly prepared one isn't stopped inadvertently
        ...
        /// <summary>
        /// Mute all audio of a specific type
        /// </summary>
        public void MuteAll()
        {
            MuteAllMusic();
        ...
        {
            MuteAllAudio(Audio.AudioType.Music);
        }
        ...
        {
            MuteAllAudio(Audio.AudioType.Sound);
        }

        /// <summary>
        /// Mute all UI sound fx
        /// </summary>
        public void MuteAllUISounds()
        {
            MuteAllAudio(Audio.AudioType.UISound);
        }

        /// <summary>
        /// Mute all ambience sounds
        /// </summary>
        public void MuteAllAmbiences()
        {
            MuteAllAudio(Audio.AudioType.Ambience);
        }

        /// <summary>
        /// Mute all voice sounds
        /// </summary>
        public void MuteAllVoices()
        {
            MuteAllAudio(Audio.AudioType.Voice);
        }

        private void MuteAllAudio(Audio.AudioType audioType)
        {
            Dictionary<int, Audio> audioDict = GetAudioTypeDictionary(audioType);
        ...
        {
            UnmuteAllAudio(Audio.AudioType.Music);
        }
        ...
        {
            UnmuteAllAudio(Audio.AudioType.Sound);
        }

        /// <summary>
        /// Unmute all UI sound fx
        /// </summary>
        public void UnmuteAllUISounds()
        {
            UnmuteAllAudio(Audio.AudioType.UISound);
        }

        /// <summary>
        /// Unmute all ambience sounds
        /// </summary>
        public void UnmuteAllAmbiences()
        {
            UnmuteAllAudio(Audio.AudioType.Ambience);
        }

        /// <summary>
        /// Unmute all voice sounds
        /// </summary>
        public void UnmuteAllVoices()
        {
            UnmuteAllAudio(Audio.AudioType.Voice);
        }

        private void UnmuteAllAudio(Audio.AudioType audioType)
        {
            Dictionary<int, Audio> audioDict = GetAudioTypeDictionary(audioType);
