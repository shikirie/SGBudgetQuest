    ...
    public class Audio
    {
        ...
        public Transform SourceTransform
        {
            ...
            set
            {
                if (value == null)
                {
                    sourceTransform = soundSystem.transform;
                }
                else
                {
        ...
        public Audio(SoundSystem soundSystem, AudioType audioType, AudioClip clip, bool loop, bool persist, float volume, float fadeInValue, float fadeOutValue, Transform sourceTransform)
        {
            ...
            Pitch = 1;
            StereoPan = 0;
            if (sourceTransform != null && sourceTransform != soundSystem.transform)
            {
                SpatialBlend = 1;
            }
            ReverbZoneMix = 1;
        ...
        private void CreateAudiosource()
        {
            ...
            AudioSource.maxDistance = Max3DDistance;
            AudioSource.minDistance = Min3DDistance;
            AudioSource.outputAudioMixerGroup = soundSystem.GetAudioMixerGroup(Type);
        }
        ...
        public void Play(float volume)
        {
            ...
            if (Pooled)
            {
                ...
                bool restoredFromPool = soundSystem.RestoreAudioFromPool(Type, AudioID);
                if (!restoredFromPool)
                {
                    return;
                }
        ...
        public void Update()
        {
            ...
            switch (Type)
            {
                case AudioType.Music:
                    {
                        AudioSource.volume = Volume * soundSystem.GlobalMusicVolume * soundSystem.GlobalVolume;
                        break;
                    }
                case AudioType.Sound:
                    {
                        AudioSource.volume = Volume * soundSystem.GlobalSoundsVolume * soundSystem.GlobalVolume;
                        break;
                    }
                case AudioType.UISound:
                    {
                        AudioSource.volume = Volume * soundSystem.GlobalUISoundsVolume * soundSystem.GlobalVolume;
                        break;
                    }
                case AudioType.Ambience:
                    {
                        AudioSource.volume = Volume * soundSystem.GlobalAmbienceVolume * soundSystem.GlobalVolume;
                        break;
                    }
                case AudioType.Voice:
                    {
                        AudioSource.volume = Volume * soundSystem.GlobalVoiceVolume * soundSystem.GlobalVolume;
                        break;
                    }
            }
